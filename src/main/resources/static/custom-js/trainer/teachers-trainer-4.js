document.addEventListener('DOMContentLoaded', function () {
    ...
    const topicSelect4 = document.getElementById("topicSelect4");
    ...
    const pupil4Select = document.getElementById("pupilSelect4");
    ...
    const answerInput4 = document.getElementById("answerInput4");
    const answerDiv4 = document.getElementById("answerDiv4");
    ...
    let totalCorrectAnswers4 = 0;
    let totalIncorrectAnswers4 = 0;
    ...
    startButton.addEventListener("click", function () {
        ...
        formData.append("topic4", topicSelect4.value);
        $.ajax({
            ...
            success: function (response) {
                ...
                showingArray4 = response.task4.taskEntry;
                correctAnswer4 = response.task4.answer;
                startTrainer();
            },
            error: function (xhr) {
                try {
    ...
    saveButton.addEventListener("click", function () {
        ...
        if (pupilsAnswer1 == null || pupilsAnswer1 === ''
            ...
            if (+correctAnswer4 === +pupilsAnswer4) {
                document.getElementById("correct4").innerText = totalCorrectAnswers4 + 1;
                totalCorrectAnswers4++;
            } else {
                document.getElementById("incorrect4").innerText = totalIncorrectAnswers4 + 1;
                totalIncorrectAnswers4++;
            }
            ...
            let results = {
                ...
                pupilId4: pupil4Select.value,
                topic4: topicSelect4.value,
                isCorrect4: +correctAnswer4 === +pupilsAnswer4,
    ...
    function startTrainer() {
        ...
        function displayElement() {
            if (index < showingArray1.length) {
                ...
                currentNumber4.style.fontSize = fontSize + 'px';
                ...
                if (index > 0 && showingArray4[index - 1] === showingArray4[index]) {
                    if (index > 1 && showingArray4[index] === showingArray4[index - 2] && !isPrefixNeeded4) {
                        currentNumber4.innerText = showingArray4[index];
                        isPrefixNeeded4 = true;
                    } else {
                        currentNumber4.innerText = "  " + showingArray4[index];
                        isPrefixNeeded4 = false;
                    }
                } else {
                    currentNumber4.innerText = showingArray4[index];
                }
                ...
                currentNumber4.hidden = true;
                answerDiv4.hidden = false;
